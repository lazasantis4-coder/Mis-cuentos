...
        
        // Integración de Escudo Parcial (z-index) y Tarjeta Colorida
        div.innerHTML = `
            <h3>${video.titulo}</h3>
            <div class="video-wrapper" style="position: relative; height: 250px; overflow: hidden;">
                <iframe width="100%" height="250" 
                    src="https://www.youtube.com/embed/${video.id}?modestbranding=1&rel=0&iv_load_policy=3" 
                    frameborder="0" 
                    allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture" 
                    allowfullscreen></iframe>
                <div style="position: absolute; top: 0; left: 0; width: 100%; height: 210px; background: transparent; z-index: 10;"></div>
            </div>
            
            <div class="enseign-card" style="background-color: #F9F3E6; border-left: 6px solid #A3B18A; padding: 12px; margin-top: 10px; border-radius: 8px; display: flex; align-items: center; gap: 10px;">
                <span style="font-size: 20px;">💡</span>
                <p style="margin: 0; color: #4A4A4A; font-size: 14px;"><strong>Enseignement :</strong> ${video.ensenanza}</p>
            </div>
        `;
