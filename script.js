...
function renderizarBloque(nombreBloque) {
    ...
    baseDatos[nombreBloque].forEach((video, index) => {
        ...
        div.innerHTML = `
            <h3>${video.titulo}</h3>
            <div class="video-wrapper" style="position: relative; height: 250px; background: #000;">
                <iframe width="100%" height="250" 
                    src="https://www.youtube.com/embed/${video.id}?modestbranding=1&rel=0&iv_load_policy=3&fs=0&disablekb=1" 
                    frameborder="0" 
