    ...
    baseDatos[nombreBloque].forEach((video, index) => {
        ...
        div.innerHTML = `
            ...
            <div class="video-placeholder" 
                 style="position: relative; height: 250px; background: #000; cursor: pointer; display: flex; align-items: center; justify-content: center;"
                 onclick="cargarVideo(this, '${video.id}')">
                <img src="${thumbnail}" style="width: 100%; height: 100%; object-fit: cover; opacity: 0.8;">
