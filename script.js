...
function renderizarBloque(nombreBloque) {
    ...
    baseDatos[nombreBloque].forEach(video => {
        const div = document.createElement('div');
        div.className = 'video-item';
        div.innerHTML = `<h3>${video.titulo}</h3><iframe src="https://www.youtube.com/embed/${video.id}" frameborder="0" allowfullscreen></iframe><p><strong>Enseignement:</strong> ${video.ensenanza}</p>`;
